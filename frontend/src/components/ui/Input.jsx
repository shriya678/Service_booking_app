// Labeled input with error + hint slots.
...
export function Input({ label, error, hint, className = '', ...rest }) {
  return (
    <label className="block">
      ...
      <input
        className={`w-full px-3.5 py-2.5 border rounded-lg text-slate-900 placeholder:text-slate-400 transition-colors focus:outline-none focus:ring-2 ${
          error
